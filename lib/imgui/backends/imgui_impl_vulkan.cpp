...
//  2016-10-18: Vulkan: Add location decorators & change to use structs as in/out in shaders, update embedded spv (produced with glslangValidator -x). Null the released resources.
